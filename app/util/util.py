        ...
        for index in range(len(img_data)):
            if index != (len(img_data) -1):
                if get_file_extension(img_data[index].filename) == ".jpg":
                    dataList.append(encode('--' + boundary))
                    dataList.append(encode('Content-Disposition: form-data; name=image; filename={0}'.format(img_data[index].filename)))
                    fileType = mimetypes.guess_type('app/base/static/temp/' + id + '/' + img_data[index].filename)[0] or 'application/octet-stream'
                    ...
                    dataList.append(encode('--' + boundary))
                    dataList.append(encode('Content-Disposition: form-data; name=file; filename={0}'.format(img_data[index].filename)))
                    fileType = mimetypes.guess_type('app/base/static/temp/' + id + '/' + img_data[index].filename)[0] or 'application/octet-stream'
                    dataList.append(encode('Content-Type: {}'.format(fileType)))
                    dataList.append(encode(''))
                    with open('app/base/static/temp/' + id + '/' + img_data[index].filename, 'rb') as f:
                ...
                if get_file_extension(img_data[index].filename) == ".jpg":
                    ...
                    dataList.append(encode('--' + boundary))
                    dataList.append(encode('Content-Disposition: form-data; name=file; filename={0}'.format(img_data[index].filename)))
                    fileType = mimetypes.guess_type('app/base/static/temp/' + img_data[index].filename)[0] or 'application/octet-stream'
                    dataList.append(encode('Content-Type: {}'.format(fileType)))
                    dataList.append(encode(''))
                    with open('app/base/static/temp/' + id + '/' + img_data[index].filename, 'rb') as f:
                        dataList.append(f.read())
